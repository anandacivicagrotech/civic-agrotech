...
- **การแพร่กระจาย**: โรคพืชแพร่กระจายก่อนที่จะตรวจพบและแก้ไข
...
- **AI Image Analysis** วิเคราะห์ใบเหลือง, จุดด่าง, โรคพืช
- **เชื่อมโยงกับ Environmental Data** หาสาเหตุและแนะนำการแก้ไข
- **Proactive Prevention** ป้องกันการแพร่กระจาย
...
[RGB Camera] → [Edge Computing] → [AI Model] → [Environmental Data] → [Recommendation Engine]
     ↓              ↓              ↓              ↓                    ↓
...
|-------|---------------------------|----------|
| 📷 **Image Capture** | RGB Camera (1080p+) | ถ่ายภาพพืชแบบสม่ำเสมอ |
...
| 🔍 **Anomaly Detection** | ตรวจจุดด่าง, เน่า, โรคพืช | >85% |
...
**ตัวอย่างที่ 3: Disease Detection**
```
📸 Image Analysis:
...
💡 AI Diagnosis: Fungal Disease (สงสัย)
✅ Recommendation: 
  - ลด RH เป็น 70-75%
  - เพิ่ม airflow
  - แยกพืชที่ติดเชื้อ
...
- Suspected: Nutrient burn + possible disease
```
...
Secondary: Fungal Risk (High RH + Low airflow)
Confidence: 87%
...
- 🔍 **Disease Classification**: แยกประเภทโรคพืชได้เฉพาะเจาะจง
